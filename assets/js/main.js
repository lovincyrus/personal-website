...
const About = {
	...
	<div id="main-container">
		<div class="about">
			...
			<p class="description">
			I am a software engineer, app developer, JS enthusiast and a cognitive science student at UC Davis. I love to learn by doing things, which is why I am <em>always</em> in progress. I firmly believe that it is not what technology stack you use that make the product great, it is how you implement it. While technology frameworks may not last, but photographs definitely will — you may check out my <a href="https://vsco.co/lovincyrus" target="blank_" class="here"><strong>photography work</strong></a>. Read my <a href="http://blog.lovincyrus.com" target="blank_" class="here"><strong>journal</strong></a> to learn more about why I do what I do.
				<br><br>My utmost passion is to connect <em>human</em> and <em>technology</em>, and to build <em>user-centric</em> products. 
				<br><br><code class="note">[-] Previously at <a href="https://hackdavis.io/" target="blank_" class="here"><strong>HackDavis</strong></a>, <a href="https://trustwalletapp.com/" target="blank_" class="here"><strong>Trust Wallet</strong></a>, <a href="https://myfave.com/" target="blank_" class="here"><strong>Fave</strong></a></code>
